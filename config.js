...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "8Ct0RYaR#kmpmpgHBF8Ut34l51KF649f8S0Vi2Hr-q6T4d912zXE",
  // ADD Your Session Id 
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_ZiDi-MD Connected Successfully!_* ✅ 

--- *👨‍💻🎉 _Welcome to ZiDi-MD!_* 🎉💗 

*🔹 OWNER:* 923247116683

_Thank you for using_ *👨‍💻 ZiDi-MD💗.*
